...
class Order(Base):
    ...
    developers = db.relationship(
        "Developer", secondary=assigned_developers, backref="orders", lazy="dynamic"
    )

    def __init__(self, title, requirements, account_id, service_id, complete):
        self.title = title
